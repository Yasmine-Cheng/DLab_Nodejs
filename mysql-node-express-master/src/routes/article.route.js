...
router.get('/page/:page', auth(), awaitHandlerFactory(articleController.getPageOfArticle)); // localhost:3331/api/v1/articles
...
router.post('/login', awaitHandlerFactory(articleController.userLogin)); // localhost:3000/api/v1/users/login
